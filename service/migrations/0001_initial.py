    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_a', models.DecimalField(decimal_places=0, max_digits=10)),
                ('item_b', models.DecimalField(decimal_places=0, max_digits=10)),
                ('item_c', models.DecimalField(decimal_places=0, max_digits=10)),
                ('item_d', models.DecimalField(decimal_places=0, max_digits=10)),
